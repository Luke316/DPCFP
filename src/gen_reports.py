...
def plot_metrics_2(T_names, r_lst, utility):
    fig1, ax1 = plt.subplots(figsize=(6, 6))
    fig2, ax2 = plt.subplots(figsize=(6, 6))
    fig3, ax3 = plt.subplots(figsize=(6, 6))
    fig4, ax4 = plt.subplots(figsize=(6, 6))
    ...
    ax5.set_xlabel('Split Rate')
    ax5.set_ylabel('MRE')
    ax5.set_xlim(0.05, 0.5)
    ax5.set_ylim(0, 0.15)
    ...
    for T_name in T_names:
        ...
        ax1.errorbar(r_lst, precision_mean, yerr=precision_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax2.errorbar(r_lst, recall_mean, yerr=recall_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax3.errorbar(r_lst, f_score_mean, yerr=f_score_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax4.errorbar(r_lst, mae_mean, yerr=mae_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax5.errorbar(r_lst, mre_mean, yerr=mre_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
    ...
    fig1.savefig('..\\reports\\split_rate_vs_precision.svg')
    fig2.savefig('..\\reports\\split_rate_vs_recall.svg')
    fig3.savefig('..\\reports\\split_rate_vs_F_score.svg')
    fig4.savefig('..\\reports\\split_rate_vs_MAE.svg')
    fig5.savefig('..\\reports\\split_rate_vs_MRE.svg')
    plt.show()


def gen_txt_2(T_names, r_lst, privacy, utility):
    with open('..\\reports\\split_rate_vs_utility.txt', 'w', newline=''):
        pass
    for T_name in T_names:
        losses =     ['Privacy           ']
        rs =         ['Utility/Split Rate']
        precisions = ['Precision         ']
        recalls =    ['Recall            ']
        f_scores =   ['F Score           ']
        maes =       ['MAE               ']
        ...
        with open('..\\reports\\split_rate_vs_utility.txt', 'a', newline='') as pu:
            if T_name == 'retail' or T_name == 'kosarak':
                pu.write(T_name.title())
            elif T_name == 'BMS1' or T_name == 'BMS2':
                pu.write(T_name)
...
def plot_metrics_3(T_names, phi_lst, utility):
    fig1, ax1 = plt.subplots(figsize=(6, 6))
    fig2, ax2 = plt.subplots(figsize=(6, 6))
    fig3, ax3 = plt.subplots(figsize=(6, 6))
    fig4, ax4 = plt.subplots(figsize=(6, 6))
    ...
    ax1.set_xlabel('Maximum Support Difference')
    ax1.set_ylabel('Precision')
    ax1.set_xlim(0.1, 1)
    ax1.set_ylim(0.0, 1)
    ...
    ax2.set_xlabel('Maximum Support Difference')
    ax2.set_ylabel('Recall')
    ax2.set_xlim(0.1, 1)
    ax2.set_ylim(0, 1)
    ...
    ax3.set_xlabel('Maximum Support Difference')
    ax3.set_ylabel('F Score')
    ax3.set_xlim(0.1, 1)
    ax3.set_ylim(0, 1)
    ...
    ax4.set_xlabel('Maximum Support Difference')
    ax4.set_ylabel('MAE')
    ax4.set_xlim(0.1, 1)
    ax4.set_ylim(0, 0.025)
    ...
    ax5.set_xlabel('Maximum Support Difference')
    ax5.set_ylabel('MRE')
    ax5.set_xlim(0.1, 1)
    ax5.set_ylim(0, 0.15)
    ...
    for T_name in T_names:
        ...
        ax1.errorbar(phi_lst, precision_mean, yerr=precision_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax2.errorbar(phi_lst, recall_mean, yerr=recall_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax3.errorbar(phi_lst, f_score_mean, yerr=f_score_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax4.errorbar(phi_lst, mae_mean, yerr=mae_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
        ax5.errorbar(phi_lst, mre_mean, yerr=mre_std, fmt=fmt, fillstyle='none', label=label, capsize=5)
    ...
    fig1.savefig('..\\reports\\maximum_support_difference_vs_precision.svg')
    fig2.savefig('..\\reports\\maximum_support_difference_vs_recall.svg')
    fig3.savefig('..\\reports\\maximum_support_difference_vs_F_score.svg')
    fig4.savefig('..\\reports\\maximum_support_difference_vs_MAE.svg')
    fig5.savefig('..\\reports\\maximum_support_difference_vs_MRE.svg')
    plt.show()


def gen_txt_3(T_names, phi_lst, privacy, utility):
